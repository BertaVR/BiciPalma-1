...
class Anclajes {
    ...
    /**
     * Anclajes es una composición (agregacion fuerte) de Anclaje
     */
    ...
    /**
     * Al introducir streams no es posible acceder por posicion al ADT Anclaje. Los
     * metodos de acceso por posicion ya no son necesarios.
     *
     */
